...
A fast-paced, action-packed 2D space shooter built using Pygame. Navigate your spaceship, shoot incoming targets, and survive as long as possible while racking up high scores!  

## 🚀 Features  
- Smooth player movement and shooting mechanics  
- Enemy targets that descend continuously  
- Real-time scoring system  
- Background music and sound effects  
- High score tracking and leaderboard  
- Interactive main menu with Play, High Scores, and Quit options  

## 🎮 How to Play  
1. **Move Left/Right**: Use the arrow keys (`←` / `→`)  
2. **Shoot**: Press `SPACE` to fire bullets  
3. **Survive**: Avoid letting targets reach the bottom  
4. **Track Score & Lives**: Your progress is displayed at the top  
5. **Game Over**: If you run out of lives, check your high score and try again!  
